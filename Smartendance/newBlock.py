...
def add_block(form, data, blockchain):
    ...
    if time.localtime().tm_hour in range(6,19):
        return "Block #{} (Day Shift) has been added to the blockchain!".format(block_to_add.index)
    else:
        return "Block #{} (Night Shift) has been added to the blockchain!".format(block_to_add.index)
